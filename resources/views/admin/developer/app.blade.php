            ...
            <div class="card">
                <div class="card-body">
                    <div class="from-group row">
                        ...
                        <div class="col-lg-12">
                            <input type="text" name="name" value="{{ env('APP_NAME') }}" required=""
                                class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="from-group row mt-2">
                        ...
                        <div class="col-lg-12">
                            <select class="form-control" name="app_debug">
                                <option value="true" {{ env('APP_DEBUG')==true ? 'selected' : '' }}>{{ __('Enable') }}
                                </option>
                                <option value="false" {{ env('APP_DEBUG')==false ? 'selected' : '' }}>{{ __('Disable')
                                    }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="from-group row mt-2">
                        ...
                        <div class="col-lg-12">
                            <select class="form-control" name="timezone">
                                ...
                                <option value="{{ $timezone }}" {{ env('TIME_ZONE')==$timezone ? 'selected' : '' }}>{{
                                    $timezone }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="from-group row mt-2">
                        ...
                        <div class="col-lg-12">
                            <select class="form-control" name="default_lang">
                                ...
                                <option value="{{ $langKey }}" {{ env('DEFAULT_LANG')==$langKey ? 'selected' : '' }}>{{
                                    $langauge }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="from-group row mt-2">
                        ...
                        <label class="col-lg-12">{{ __('Rate') }}</label>
                        <div class="col-lg-12">

                            <div class="col-lg-12">
                                <input type="number" name="rate" value="{{ env('RATE') }}" required=""
